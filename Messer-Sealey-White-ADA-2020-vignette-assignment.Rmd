...
# Joining aerial and tactile treatments with their centralities and vipernames into one tibble
...
## running the wilcoxon analysis on our updated dataframe to compare viper centrality in the tactile and aerial treatment conditions  
wilcox_centrality <- wilcox.test(viper_centrality$centrality_t, viper_centrality$centrality_a, paired=TRUE)
